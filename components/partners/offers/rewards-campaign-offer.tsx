...
const content = {
  ...
  fr: {
    title: "Programme de Récompenses pour Achats Vérifiés",
    steps: [
      { icon: "/Icons/rewards/icon-1.svg", label: "Vérifier les achats" },
      { icon: "/Icons/rewards/icon-2.svg", label: "Récompenser les acheteurs" },
      { icon: "/Icons/rewards/icon-3.svg", label: "Développer vos marques" },
    ],
    ...
    flow: [
      {
        image: "/images/partners/what-we-offer/mobile-homepage.svg",
        title: "Decouvrir",
        desc: "Les acheteurs trouvent des promotions sur PikSou",
      },
      {
        image: "/images/partners/what-we-offer/shop.svg",
        title: "Acheter",
        desc: "Ils achètent ce dont ils ont besoin dans leurs magasins préférés",
      },
      {
        image: "/images/partners/what-we-offer/receipt-scanner.svg",
        title: "Verifier",
        desc: "Ils scannent leur reçu. Nous vérifions les achats réels.",
      },
      {
        image: "/images/partners/what-we-offer/reward-system.svg",
        title: "Recompenser",
        desc: "Les acheteurs reçoivent des récompenses instantanées qu'ils peuvent utiliser et apprécier.",
      },
      {
        image: "/images/partners/what-we-offer/analytics-dashboard.svg",
        title: "Grandir",
        desc: "Vous obtenez des analyses réelles qui développent vos marques.",
      },
    ],
    partnerTitle: "Devenir partenaire fondateur",
    partnerCopy:
      "Rejoignez un groupe sélectionné de distributeurs avant-gardistes qui façonnent l'avenir des promotions à Maurice.",
    partnerBenefits: [
      { image: "/Icons/rewards/icon-5.png", title: "Accès Anticipé", desc: "aux fonctionnalités exclusives" },
      { image: "/Icons/rewards/icon-6.png", title: "Co-créer", desc: "des solutions promotionnelles plus intelligentes" },
      { image: "/Icons/rewards/icon-7.png", title: "Des Partenariats", desc: "plus solides" },
      { image: "/Icons/rewards/icon-8.png", title: "De Meilleurs Résultats", desc: "ensemble" },
    ],
    shoppersWin: "Les Acheteurs Gagnent",
    distributorsWin: "Les Distributeurs Gagnent",
    shopperWins: [
      { image: "/Icons/rewards/icon-9.png", label: "Économisent sur les marques qu'ils aiment" },
      { image: "/Icons/rewards/icon-10.png", label: "Des récompenses instantanées et agréables" },
      { image: "/Icons/rewards/icon-11.png", label: "Des offres personnalisées rien que pour eux" },
      { image: "/Icons/rewards/icon-12.png", label: "Une expérience d'achat plus intelligente" },
    ],
    distributorWins: [
      { image: "/Icons/rewards/icon-8.png", label: "Mesurer le ROI réel" },
      { image: "/Icons/rewards/icon-13.png", label: "Acquérir de nouveaux clients" },
      { image: "/Icons/rewards/icon-14.png", label: "Augmenter les achats répétés" },
      { image: "/Icons/rewards/icon-15.png", label: "Comprendre vos acheteurs" },
    ],
    signoff: "Plus intelligent à chaque fois. Plus fort à chaque campagne !",
  },
}
